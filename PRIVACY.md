...
This extension collects nothing and sends nothing to the developer.

**What's stored, and where:** your name, weather locations, mandala settings,
to-dos, sticky note, daily intention, and focus-timer time are all saved with
the browser's built-in `storage.local` API, on your device only. Uninstalling
